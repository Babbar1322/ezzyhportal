                        ...
                        <div class="col-md-3">
                          {{-- <form id="sortForm" class="mt-3"> --}}
                            <select name="loan_status" id="sort" class="form-control mt-3">
                              ...
                              <option value="submitted" {{request()->loan_status && request()->loan_status=='submitted'?'selected':''}}>Submitted</option>
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      @php 
                      // print_r($user->dealer->name);
                          $name = App\Models\User::where('id',$user->sid)->pluck('name');
                          $dealer = App\Models\User::where("id",$user->pid)->where("id","!=",1)->first();
                      @endphp
                      <tr>
                        <td>{{ $i++ }}</td>
                        ...
                        {{-- <td>{{isset($dealer)?$dealer->name:""}}</td>
                        <td>{{isset($dealer)?$dealer->login_code:""}}</td> --}}
                    ...
                    <td class="d-flex">
                        @can('customer-edit')
                        <a class="btn btn-warning mr-2" href="{{route('customer.edit',$user->id)}}">Edit</a>
                        @endcan
                        @can('customer-delete')
